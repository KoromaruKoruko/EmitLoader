...
{
    internal class MixedPointerType : IType
    {
        ...
        public MixedPointerType(IType elementType) => this.elementType = elementType;
        private readonly IType elementType;

        public Type GetBuiltType() => this.elementType.GetBuiltType().MakePointerType();
